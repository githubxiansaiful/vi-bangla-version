try {
    let t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
        e = (new t.Error).stack;
    e && (t._sentryDebugIds = t._sentryDebugIds || {}, t._sentryDebugIds[e] = "842fcfa2-012e-4cbf-92c0-4fa64520b6c8", t._sentryDebugIdIdentifier = "sentry-dbid-842fcfa2-012e-4cbf-92c0-4fa64520b6c8")
} catch (t) {}
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [8357], {
        68357: function(t, e, n) {
            n.d(e, {
                Z: function() {
                    return I
                }
            ...
            function D(t, e, n) {
                ...
                let O = t.ownerDocument,
                    ...
                    A = (I = [], {
                        init: function(t, e) {
                            return (I = e.filter(({
                                options: t
                            }) => !1 !== L.optionsAtMedia(t).active)).forEach(e => e.init(t, L)), e.reduce((t, e) => Object.assign(t, {
                                [e.name]: e
                            }), {})
                        },
                        destroy: function() {
                    ...
                    z = !1,
                    C = T(E, D.globalOptions),
                    _ = T(C),
                    B = [];

                function R(e, n) {
                    !z && (_ = j(C = T(C, e)), B = n || B, function() {
                        let {
                            container: e,
                            slides: n
                        } = _;
                        ...
                        let r = function(t, e, n, r, i, o, u) {
                            ...
                            let {
                            ...
                            }($, B, R, n, L || !!P, i), K = function(t, e, n, r, i, o, u, a, l) {
                                let {
                                    startEdge: s,
                                    endEdge: d,
                                    direction: h
                                ...
                                return l
                            }(m(ti), k, L), tc = tu.clone(), ta = p(n), tl = ({
                                dragHandler: t,
                                scrollBody: e,
                                scrollBounds: n,
                                options: {
                                ...
                                return h
                            }(tp, tm, tg, th, A, 0), tb = function(t, e, n, r, i) {
                                let {
                                    reachedAny: o,
                                    removeOffset: u,
                                    constrain: c
                            ...
                            }(L, ti, te, to, th), tv = function(t, e, n, r, i, o, u) {
                                function c(i) {
                                    let c = i.distance,
                                        a = i.index !== e.get();
                            ...
                            }(X, P, ti, tr, K, ta), tD = function(t, e, n, r, i, o, u, a) {
                                let s = {
                                        passive: !0,
                                        capture: !0
                                    },
                                ...
                                dragHandler: function(t, e, n, r, i, o, u, c, a, s, p, g, m, h, y, w, S, E, D) {
                                    let {
                                        ...
                                        passive: !1
                                    }, A = v(), M = v(), F = x(50, 225).constrain(h.measure(20)), T = {
                                        mouse: 300,
                                        touch: 400
                                    }, j = {
                                        mouse: 500,
                                        touch: 600
                                    }, N = y ? 43 : 25, P = !1, H = 0, V = 0, z = !1, C = !1, _ = !1, B = !1;
                                    ...
                                    function $(t) {
                                        let e = p.byDistance(0, !1).index !== g.get(),
                                            n = o.pointerUp(t) * (y ? j : T)[B ? "mouse" : "touch"],
                                            r = function(t, e) {
                                                let n = g.add(-1 * d(t)),
                                        ...
                                        C = !1, z = !1, M.clear(), s.useDuration(N - 10 * i).useFriction(.68 + i / 50), a.distance(r, !y), B = !1, m.emit("pointerUp")
                                    }
                                    ...
                                    return {
                                        init: function(t) {
                                            D && A.add(e, "dragstart", t => t.preventDefault(), L).add(e, "touchmove", () => void 0, L).add(e, "touchend", () => void 0).add(e, "touchstart", c).add(e, "mousedown", c).add(e, "touchcancel", $).add(e, "contextmenu", $).add(e, "click", q, !0);

                                            function c(c) {
                                                (l(D) || D(t, c)) && function(t) {
                                                    let c = b(t, r);
                                                    B = c, _ = y && c && !t.buttons && P, P = f(i.get() - u.get()) >= 2, c && 0 !== t.button || function(t) {
                                                        let e = t.nodeName || "";
                                                        return k.includes(e)
                                                    }(t.target) || (z = !0, o.pointerDown(t), s.useFriction(0).useDuration(0), i.set(u), function() {
                                                        let t = B ? n : e;
                                                        M.add(t, "touchmove", R, L).add(t, "touchend", $).add(t, "mousemove", R, L).add(t, "mouseup", $)
                                ...
                                }($, i), tp, tf, tv, ty, tb, tu, u, U, M, F, N, 0, z),
                                eventStore: tw,
                                percentOfView: U,
                                index: tu,
                                indexPrevious: tc,
                        ...
                        options: t
                    }) => t)]).forEach(t => M.add(t, "change", $)), _.active && (r.translate.to(r.location.get()), r.animation.init(), r.slidesInView.init(), r.slideFocus.init(X), r.eventHandler.init(X), r.resizeHandler.init(X), r.slidesHandler.init(X), r.options.loop && r.slideLooper.loop(), o.offsetParent && u.length && r.dragHandler.init(X), i = A.init(X, B)))
                }
                ...
                function q() {
                    r.dragHandler.destroy(), r.eventStore.clear(), r.translate.clear(), r.slideLooper.clear(), r.resizeHandler.destroy(), r.slidesHandler.destroy(), r.slidesInView.destroy(), r.animation.destroy(), A.destroy(), M.clear()
                }
